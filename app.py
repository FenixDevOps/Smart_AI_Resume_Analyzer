    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/FenixDevOps/Smart_AI_Resume_Analyzer' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/bathini-manikanta/" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Bathini Manikanta </b>
                </a>
            </p>
